...
const Page = () => {
  return (
    <div>
      <div id='page1'>
         <h1>AI & ML PR<span><svg class="c-bttn__morph" fill="none" viewBox="0 0 131 136">
        ...
        <p>We partner with AI &amp; ML&nbsp;businesses, guiding them from series A <br />to series D and beyond with our expertize in</p>
